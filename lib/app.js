...
var prayerConfigFE = {
    ...
    adjustments: [
        { prayerName: prayer.PrayersName.FAJR, adjustments: 10 },
        { prayerName: prayer.PrayersName.DHUHR, adjustments: 10 },
        { prayerName: prayer.PrayersName.ASR, adjustments: 10 },
        { prayerName: prayer.PrayersName.MAGHRIB, adjustments: 2 },
        { prayerName: prayer.PrayersName.ISHA, adjustments: -10 },
    ]
};
async function buildLocationObject() {
    try {
        ...
        let result = await prayerManager.savePrayerConfig(prayerConfigFE);
        console.log(result);
