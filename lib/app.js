...
async function buildLocationObject() {
    ...
    try {
        ...
        let value = prayerManager.prayerTime;
        //value.method
        // console.log(value);
        let serializedValue = serializr_1.serialize(prayer.PrayersTime, value);
        //console.log(serializedValue)
        let valueDesrialized = serializr_1.deserialize(prayer.PrayersTime, serializedValue);
        //   console.log(util.inspect(valueDesrialized.prayers, {showHidden: false, depth: null}))
        let prayerManagerSerialized = new manager.PrayerManager(valueDesrialized);
