...
const userscache_1 = require("./configurators/userscache");
// import R from "ramda";
...
async function buildLocationObject() {
    ...
    try {
        ...
        let value = await prayerUserCache.getPrayerTimeCache({ deviceID: "45effedd" });
        //  console.log(util.inspect(value, {showHidden: false, depth: null}))
        let prayerManager = new manager.PrayerManager(value);
