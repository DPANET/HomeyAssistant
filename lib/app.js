...
async function buildLocationObject() {
    ...
    try {
        ...
        let configProvider = configuration_1.ConfigProviderFactory.createConfigProviderFactory(configuration_1.ConfigProviderName.CLIENT);
        let prayerConfig = await configProvider.getPrayerConfig({ profileID: "45effedd" });
        let locationConfig = await configProvider.getLocationConfig({ profileID: "45effedd" });
