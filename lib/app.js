...
const event = __importStar(require("./managers/event"));
...
function buildLocationObject() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            let prayerConfig = yield new cg.Configurator().getPrayerConfig();
            let prayerManager = yield manager.PrayerTimeBuilder
            ...
            let prayerEventManager = new event.PrayersEventProvider(prayerManager);
