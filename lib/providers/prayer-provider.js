...
class PrayerTimeProvider extends PrayerProvider {
    ...
    getDB() {
        return __awaiter(this, void 0, void 0, function* () {
            if (util_1.isNullOrUndefined(this._db))
                return this._db = yield lowdb_1.default(new FileASync_1.default(this.fileName));
            else
                return this._db;
        });
    }
    getPrayerLatitude() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.getDB().then(result => result.get(prayerTimePaths.latitude).value());
        });
    }
    getPrayerLatitudeById(index) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.getObjectById(index, () => this.getPrayerLatitude());
        });
    }
    getPrayerMethodUrl() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.getDB().then(result => result.get(prayerTimePaths.methodsUrl).value());
        });
    }
    ...
    getPrayerMethods() {
        return __awaiter(this, void 0, void 0, function* () {
            let err, result, url;
            [err, url] = yield to(this.getPrayerMethodUrl());
            if (err)
            ...
            [err, result] = yield to(request.get(queryString));
            if (err)
                return Promise.reject(err.message = PrayerErrorMessages.TIME_OUT);
            return this.parsePrayerMethods(result['data']);
        });
    }
    getPrayerMethodsById(index) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.getObjectById(index, () => this.getPrayerMethods());
        });
    }
    getPrayerSchools() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.getDB().then(result => result.get(prayerTimePaths.schools).value());
        });
    }
    getPrayerSchoolsById(index) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.getObjectById(index, () => this.getPrayerSchools());
        });
    }
    getPrayerTime(prayerSettings, prayerLocation) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let i = 0; i <= duration; i++) {
                [err, url] = yield to(this.getPrayerTimeUrl());
                if (err)
    ...
    getPrayerTimeUrl() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.getDB().then(result => result.get(prayerTimePaths.prayerTimeUrl).value());
        });
    }
    ...
    getPrayerMidnight() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.getDB().then(result => result.get(prayerTimePaths.midnight).value());
        });
    }
    getPrayerMidnightById(index) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.getObjectById(index, () => this.getPrayerMidnight());
        });
    }
    getObjectById(index, fn) {
        return __awaiter(this, void 0, void 0, function* () {
            let err, list, listObject;
            const filterById = ramda.where({ id: ramda.equals(index) });
            [err, list] = yield to(fn());
            if (err)
                return Promise.reject(PrayerErrorMessages.FILE_NOT_FOUND);
