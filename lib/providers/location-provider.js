...
class GoogleLocationProvider extends LocationProvider {
    ...
    getLocationByCoordinates(lat, lng) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!util_1.isNullOrUndefined(lat) && !util_1.isNullOrUndefined(lng)) {
                [err, googleLocation] = yield to(this._googleMapClient.reverseGeocode({
                    latlng: [lat, lng],
    ...
    getTimeZoneByCoordinates(lat, lng) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!util_1.isNullOrUndefined(lat) && !util_1.isNullOrUndefined(lng)) {
                [err, googleTimeZone] = yield to(this._googleMapClient
    ...
    getLocationByAddress(address, countryCode) {
        return __awaiter(this, void 0, void 0, function* () {
            let googleLocation, err;
            if (!util_1.isNullOrUndefined(address) && !util_1.isNullOrUndefined(countryCode)) {
                [err, googleLocation] = yield to(this._googleMapClient.
