...
exports.PrayersTime = exports.PrayersSettings = exports.Prayers = exports.PrayersTiming = exports.PrayersTypes = exports.PrayerType = exports.Methods = exports.LatitudeMethod = exports.AdjsutmentMethod = exports.MidnightMode = exports.Schools = exports.PrayersName = void 0;
...
(function (Methods) {
    ...
    Methods[Methods["Dubai"] = 16] = "Dubai";
...
class Prayers {
    constructor(prayerTime) {
        if (!(0, isNullOrUndefined_1.isNullOrUndefined)(prayerTime))
...
class PrayersSettings {
    constructor(prayersSettings) {
        if (!(0, isNullOrUndefined_1.isNullOrUndefined)(prayersSettings))
