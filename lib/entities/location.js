...
exports.Location = exports.LocationTypeName = void 0;
...
class Location {
    constructor(location, timeZone) {
        if (!(0, isNullOrUndefined_1.isNullOrUndefined)(location)) {
        ...
        if (!(0, isNullOrUndefined_1.isNullOrUndefined)(timeZone)) {
