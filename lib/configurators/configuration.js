...
exports.ConfigProviderFactory = exports.ConfigProviderName = void 0;
...
class ConfigProvider {
    ...
    mergePrayerConfig(original, target) {
        ...
        let mergedList = ramda.mergeDeepWithKey(concatValues, original, target);
        updated = ramda.omit(['startDate', 'endDate', '$init'], mergedList);
        return updated;
    }
    mergeLocationConfig(original, target) {
        let updated;
        updated = ramda.merge(original, target);
        return updated;
    }
}
