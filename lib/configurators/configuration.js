...
exports.ConfigProviderFactory = exports.ClientConfigurator = exports.ConfigProvider = exports.ConfigProviderName = void 0;
...
class ClientConfigurator extends ConfigProvider {
    constructor(fileName) {
        ...
        if (!(0, isNullOrUndefined_1.isNullOrUndefined)(fileName))
    ...
    async updateLocationConfig(locationConfig, id) {
        try {
            ...
            if ((0, isNullOrUndefined_1.isNullOrUndefined)(result))
    ...
    async getLocationConfig(id) {
        ...
        if (err || (0, isNullOrUndefined_1.isNullOrUndefined)(result))
    ...
    async getPrayerConfig(id) {
        ...
        return {
            ...
            startDate: (0, isNullOrUndefined_1.isNullOrUndefined)(result.startDate) ? utility_1.DateUtil.getNowDate() : utility_1.DateUtil.formatDate(result.startDate),
            endDate: (0, isNullOrUndefined_1.isNullOrUndefined)(result.endDate) ? utility_1.DateUtil.addMonth(1, utility_1.DateUtil.getNowDate()) : utility_1.DateUtil.formatDate(result.endDate),
            adjustments: result.adjustments,
        };
    }
    async getDB() {
        if ((0, isNullOrUndefined_1.isNullOrUndefined)(this._db))
            return this._db = await (0, lowdb_1.default)(new FileAsync_1.default(this._fileName));
        else
            return this._db;
    }
    async getConfig(id) {
...
class ConfigProviderFactory {
    static createConfigProviderFactory(providerType, configs) {
        ...
        if ((0, isNullOrUndefined_1.isNullOrUndefined)(nconf_1.default))
