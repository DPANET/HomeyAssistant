...
class PrayersRefreshEventProvider extends EventProvider {
    ...
    runNextPrayerSchedule() {
        this._refreshPrayersEvent = new cron.CronJob(this._prayerManager.getPrayerEndPeriond(), () => __awaiter(this, void 0, void 0, function* () {
            yield this.scheduleRefresh();
        }), null, true);
    ...
    scheduleRefresh() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                this._prayerManager = yield this._prayerManager.updatePrayersDate(startDate, endDate);
