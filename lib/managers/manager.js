...
__decorate([
    serializr_1.serializable(serializr_1.object(prayer.PrayersSettings))
], PrayerSettingsBuilder.prototype, "_prayerSettings", void 0);
...
__decorate([
    serializr_1.serializable(serializr_1.object(location.Location))
], LocationBuilder.prototype, "_location", void 0);
...
__decorate([
    serializr_1.serializable(serializr_1.list(serializr_1.object(prayer.Prayers)))
], PrayerTimeBuilder.prototype, "_prayers", void 0);
...
class PrayerManager {
    ...
    async updatePrayerConfig(prayerConfig, config) {
        try {
            ...
            let configurator = configuration_1.ConfigProviderFactory.createConfigProviderFactory();
...
__decorate([
    serializr_1.serializable(serializr_1.object(prayer.PrayersTime))
], PrayerManager.prototype, "prayerTime", null);
