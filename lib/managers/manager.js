...
exports.PrayerManager = exports.PrayerTimeBuilder = exports.LocationBuilder = exports.PrayerSettingsBuilder = void 0;
...
class PrayerSettingsBuilder {
    constructor(prayerProvider, validator, prayerConfig) {
        ...
        if (!(0, isNullOrUndefined_1.isNullOrUndefined)(prayerConfig)) {
            this._prayerSettings.midnight.id = (0, isNullOrUndefined_1.isNullOrUndefined)(prayerConfig.midnight) ? prayer.MidnightMode.Standard : prayerConfig.midnight;
            this._prayerSettings.method.id = (0, isNullOrUndefined_1.isNullOrUndefined)(prayerConfig.method) ? prayer.Methods.Mecca : prayerConfig.method;
            this._prayerSettings.adjustments = (0, isNullOrUndefined_1.isNullOrUndefined)(prayerConfig.adjustments) ? this._prayerSettings.adjustments : prayerConfig.adjustments;
            this._prayerSettings.school.id = (0, isNullOrUndefined_1.isNullOrUndefined)(prayerConfig.school) ? prayer.Schools.Shafi : prayerConfig.school;
            this._prayerSettings.latitudeAdjustment.id = (0, isNullOrUndefined_1.isNullOrUndefined)(prayerConfig.latitudeAdjustment) ? prayer.LatitudeMethod.Angle : prayerConfig.latitudeAdjustment;
            this._prayerSettings.startDate = (0, isNullOrUndefined_1.isNullOrUndefined)(prayerConfig.startDate) ? utility_1.DateUtil.getNowDate() : prayerConfig.startDate;
            this._prayerSettings.endDate = (0, isNullOrUndefined_1.isNullOrUndefined)(prayerConfig.endDate) ? utility_1.DateUtil.addMonth(1, utility_1.DateUtil.getNowDate()) : prayerConfig.endDate;
            this._prayerSettings.adjustmentMethod.id = (0, isNullOrUndefined_1.isNullOrUndefined)(prayerConfig.adjustmentMethod) ? prayer.AdjsutmentMethod.Server : prayerConfig.adjustmentMethod;
        }
        else {
...
class LocationBuilder {
    constructor(locationProvider, validator, locationConfig) {
        ...
        if (!(0, isNullOrUndefined_1.isNullOrUndefined)(locationConfig)) {
            this._location.latitude = (0, isNullOrUndefined_1.isNullOrUndefined)(locationConfig.location.latitude) ? null : locationConfig.location.latitude;
            this._location.longtitude = (0, isNullOrUndefined_1.isNullOrUndefined)(locationConfig.location.longtitude) ? null : locationConfig.location.longtitude;
            this._location.countryCode = (0, isNullOrUndefined_1.isNullOrUndefined)(locationConfig.location.countryCode) ? null : locationConfig.location.countryCode;
            this._location.countryName = (0, isNullOrUndefined_1.isNullOrUndefined)(locationConfig.location.countryName) ? null : locationConfig.location.countryName;
            this._location.address = (0, isNullOrUndefined_1.isNullOrUndefined)(locationConfig.location.address) ? null : locationConfig.location.address;
            this._location.city = (0, isNullOrUndefined_1.isNullOrUndefined)(locationConfig.location.city) ? null : locationConfig.location.city;
            this._location.timeZoneId = (0, isNullOrUndefined_1.isNullOrUndefined)(locationConfig.timezone.timeZoneId) ? null : locationConfig.timezone.timeZoneId;
            this._location.timeZoneName = (0, isNullOrUndefined_1.isNullOrUndefined)(locationConfig.timezone.timeZoneName) ? null : locationConfig.timezone.timeZoneName;
            this._location.rawOffset = (0, isNullOrUndefined_1.isNullOrUndefined)(locationConfig.timezone.rawOffset) ? null : locationConfig.timezone.rawOffset;
            this._location.dstOffset = (0, isNullOrUndefined_1.isNullOrUndefined)(locationConfig.timezone.dstOffset) ? null : locationConfig.timezone.dstOffset;
        }
    }
    ...
    async createLocation() {
        ...
        if (validationResult === false)
            return Promise.reject(this._validtor.getValidationError());
        if (!(0, isNullOrUndefined_1.isNullOrUndefined)(this._location.latitude))
        ...
        else if ((!(0, isNullOrUndefined_1.isNullOrUndefined)(this._location.address)))
...
class PrayerTimeBuilder {
    ...
    static createPrayerTimeBuilder(locationConfig, prayerConfig) {
        ...
        let locationBuilder = LocationBuilder
            .createLocationBuilder((0, isNullOrUndefined_1.isNullOrUndefined)(locationConfig) ? null : locationConfig);
        let prayerSettingsBuilder = PrayerSettingsBuilder
            .createPrayerSettingsBuilder((0, isNullOrUndefined_1.isNullOrUndefined)(prayerConfig) ? null : prayerConfig);
...
class PrayerManager {
    ...
    async updatePrayerConfig(prayerConfig, id, configProvider) {
        try {
            ...
            let configurator;
            if ((0, isNullOrUndefined_1.isNullOrUndefined)(configProvider))
    ...
    getPrayerTime(prayerName, prayerDate) {
        prayerDate = ((0, isNullOrUndefined_1.isNullOrUndefined)(prayerDate) ? new Date() : prayerDate);
        let prayersByDate = this.getPrayersByDate(prayerDate);
        if (!(0, isNullOrUndefined_1.isNullOrUndefined)(prayersByDate)) {
    ...
    getUpcomingPrayer(date, prayerType) {
        let dateNow;
        if ((0, isNullOrUndefined_1.isNullOrUndefined)(date))
        ...
        if (!(0, isNullOrUndefined_1.isNullOrUndefined)(todayPrayers)) {
            ...
            for (let i = 0, prev, curr; i < listOfPrayers.length; i++) {
                ...
                if (!(0, isNullOrUndefined_1.isNullOrUndefined)(upcomingPrayer))
    ...
    processUpcomingPrayer(prev, curr, index, array, dateNow) {
        ...
        else if (!(0, isNullOrUndefined_1.isNullOrUndefined)(curr) && prev.prayerTime <= dateNow && curr.prayerTime >= dateNow)
            return array[index];
        else if ((0, isNullOrUndefined_1.isNullOrUndefined)(curr) && array.length === index) {
