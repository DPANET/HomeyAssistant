...
class PrayerManager {
    ...
    constructor(prayerTime, prayerTimeBuilder, configProvider) {
        this._prayerTime = prayerTime;
        //   this._prayerEvents = new prayer.PrayerEvents();
        this._prayerTimeBuilder = prayerTimeBuilder;
        this._configProvider = isNullOrUndefined_1.isNullOrUndefined(configProvider) ? configuration_1.ConfigProviderName.CLIENT : configProvider;
    }
    async updatePrayerConfig(prayerConfig, config) {
        try {
            ...
            let configurator = configuration_1.ConfigProviderFactory.createConfigProviderFactory(this._configProvider);
